...
<html lang="en">
<head>
<title>DeZone Fitness Admin</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">DeZone Fitness Admin</a></h1>
</div>
<!--close-Header-part--> 
            ...
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                    <tr>
                      <td><h4>DeZone Fitness</h4></td>
                    </tr>
                    <tr>
                      <td>206/17, Christuraja Place, Kimbulapitiya Rd, Negombo</td>
                    </tr>
                    
                    <tr>
                      <td>Tel: 077 225 2604</td>
                    </tr>
                    <tr>
                      <td >Email: dezonefitness@gmail.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By John Delan Fernando</a> </div>
</div>
